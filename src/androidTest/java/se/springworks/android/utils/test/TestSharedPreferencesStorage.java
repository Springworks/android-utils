...
public class TestSharedPreferencesStorage extends AndroidTestCase {
  ...
  private static final Integer[] INTEGER_OBJECT_ARRAY = {Integer.MIN_VALUE, Integer.MAX_VALUE,
                                                         Integer.valueOf(
      3), Integer.valueOf(4)};
  private static final Long[] LONG_OBJECT_ARRAY = {Long.MIN_VALUE, Long.MAX_VALUE,
                                                   Long.valueOf(3), Long.valueOf(
      4)};
  @Inject
