...
/**
 * Utility to execute a series of async tasks in sequence and trigger a callback once all of the
 * async tasks have completed
 *
 * @author bjornritzl
 */
...
//	}
  ...
  /**
   * Stops the sequence and removes all calls. All listeners will be removed (without being called)
   */
  ...
  /**
   * Start the sequence of async calls. If the sequence is already started or completed nothing will
   * happen.
   */
