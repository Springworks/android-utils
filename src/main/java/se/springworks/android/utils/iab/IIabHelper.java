...
public interface IIabHelper {
  ...
  void launchPurchaseFlow(Activity act,
                          String sku,
                          int requestCode,
  ...
  void launchSubscriptionPurchaseFlow(Activity act,
                                      String sku,
                                      int requestCode,
                                      OnIabPurchaseFinishedListener listener);
   ...
   * purchase data when the purchase completes. This extra data will be permanently bound to that
   ...
   */
  Inventory queryInventory(boolean querySkuDetails,
