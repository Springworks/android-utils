...
public class Base64 {
   ...
   */
  private final static byte[] WEBSAFE_DECODABET = {-9, -9, -9, -9, -9, -9, -9, -9, -9,
  // Decimal  0 -  8
                                                   -5, -5, // Whitespace: Tab and Linefeed
                                                   -9, -9, // Decimal 11 - 12
                                                   -5, // Whitespace: Carriage Return
   ...
   * @return decoded data
   */
  public static byte[] decodeWebSafe(byte[] source, int off, int len) throws
   ...
   * @return decoded data
   */
  public static byte[] decode(byte[] source, int off, int len, byte[] decodabet) throws
                                                                                 Base64DecoderException {
    int len34 = len * 3 / 4;
    ...
    for (i = 0; i < len; i++) {
      ...
      if (sbiDecode >= WHITE_SPACE_ENC) { // White space Equals sign or better
        ...
        throw new Base64DecoderException("Bad Base64 input character at " +
                                         i +
                                         ": " +
                                         source[i + off] +
                                         "(decimal)");
