...
//			throw new IllegalStateException("IAB helper is already set up.");
        ...
        try {
          ...
          if (listener != null) {
            listener.onIabSetupFinished(new IabResult(IABHELPER_REMOTE_EXCEPTION,
                                                      "RemoteException while setting up in-app " +
                                                      "billing."));
          }
          e.printStackTrace();
          return;
  ...
  public void launchPurchaseFlow(Activity act,
    ...
    if (itemType.equals(ITEM_TYPE_SUBS) && !mSubscriptionsSupported) {
      flagEndAsync();
      if (listener != null) {
        listener.onIabPurchaseFinished(new IabResult(IABHELPER_SUBSCRIPTIONS_NOT_AVAILABLE,
                                                     "Subscriptions are not available."), null);
      }
      return;
    }
    ...
    try {
      ...
      flagEndAsync();
      if (listener != null) {
        listener.onIabPurchaseFinished(new IabResult(IABHELPER_SEND_INTENT_FAILED,
                                                     "Failed to send intent."), null);
      }
    }
    catch (RemoteException e) {
      ...
      flagEndAsync();
      if (listener != null) {
        listener.onIabPurchaseFinished(new IabResult(IABHELPER_REMOTE_EXCEPTION,
                                                     "Remote exception while starting purchase " +
                                                     "flow"),
                                       null);
      }
    }
      ...
      flagEndAsync();
      if (listener != null) {
        listener.onIabPurchaseFinished(new IabResult(IABHELPER_UNKNOWN_ERROR,
                                                     "Exception while starting purchase flow"),
                                       null);
      }
    }
  }
  ...
  int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException {
    ...
    do {
      ...
      for (int i = 0; i < purchaseDataList.size(); ++i) {
        ...
        logDebug("verifyPurchase() base64 = " +
                 mSignatureBase64 +
                 " data = " +
                 purchaseData +
                 " signature = " +
  ...
  int querySkuDetails(String itemType, Inventory inv, List<String> moreSkus) throws
                                                                             RemoteException,
                                                                             JSONException {
