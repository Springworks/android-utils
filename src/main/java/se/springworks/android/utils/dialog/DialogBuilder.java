...
//		b.builder.setView(tv);
  ...
  public static Dialog showConfirmCancel(Context context,
                                         int titleId,
                                         int messageId,
                                         int confirmId,
                                         int cancelId,
                                         DialogInterface.OnClickListener confirmListener) {
    return DialogBuilder.create(context, titleId, messageId).addPositiveButton(confirmId,
                                                                               confirmListener)
                        .addNegativeButton(cancelId).setCancelable(true).show();
  }

  public static Dialog showConfirm(Context context,
                                   int titleId,
                                   int messageId,
                                   int confirmId,
                                   DialogInterface.OnClickListener confirmListener) {
  ...
  public static Dialog show(Context context, String title, SpannableString message) {
    return DialogBuilder.create(context, title, message).setCancelable(false).show();
  }
