...
public class StreamUtils {
  ...
  /**
   * Compares two streams http://stackoverflow.com/a/4245962/1266551
   *
   * @param i1
   * @param i2
   *
  ...
  /**
   * Get a string with default encoding from a stream From: http://stackoverflow
   * .com/a/5445161/1266551
   *
   * @param is
   *
   * @return
  ...
  /**
   * Get a string with a specific encoding from a stream http://stackoverflow.com/a/5445161/1266551
   *
   * @param is
   * @param encoding
   *
  ...
  public static byte[] getAsBytes(InputStream is, int bufferSize) throws IOException {
  ...
  /**
   * Closes a stream or similar class implementing {@link Closeable} without throwing any
   * exceptions
   *
