  ...
  private void init(Context context) {
    ...
    scaleGestureDetector = new ScaleGestureDetector(context,
                                                    new ScaleGestureDetector
                                                      ...
                                                      public boolean onScaleBegin(
                                                        ...
                                                        zoomCenter.set(detector.getFocusX(),
                                                                       detector.getFocusY());
                                                        state = State.ZOOM;
                                                        previousScaleFactor = detector
                                                            .getScaleFactor();
                                                        invalidate();
                                                        return true;
                                                      }
                                                      ...
                                                      public boolean onScale(ScaleGestureDetector
                                                        ...
                                                        final float scaleFactor = detector
                                                            .getScaleFactor();
                                                        float scaleRatio = (scaleFactor /
                                                                            previousScaleFactor);
    ...
    gestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
      ...
      public boolean onScroll(MotionEvent initial, MotionEvent current, float dx, float dy) {
        ...
        boolean distanceAboveThreshold = Math.abs(x - touchDown.x) > CLICKTHRESHOLD || Math.abs(y -
                                                                                                touchDown.y) >
                                                                                       CLICKTHRESHOLD;
        lastTouch.set(x, y);
