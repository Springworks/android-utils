...
public class SystemSettings implements ISystemSettings {
  ...
  // http://stackoverflow.com/questions/12466878/how-to-check-programmatically-if-data-roaming-is
  // -enabled-disabled
  @Override @SuppressWarnings ("deprecation")
  public boolean isDataRoamingEnabled() {
    try {
      return Settings.Secure.getInt(context.getContentResolver(), Settings.Secure.DATA_ROAMING) ==
             1;
    }
