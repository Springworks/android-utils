...
/**
 * https://developers.google.com/maps/documentation/directions <p/> http://maps.googleapis
 * .com/maps/api/directions/json?origin=Mickelsbergsv%C3%A4gen+354&destination=Sergels+torg
 * &sensor=true&mode=transit&departure_time=1377897244
 * <p/> http://stackoverflow.com/questions/9340800/detect-the-nearest-transit-stop-from-the-given
 * -location
 *
 * @author bjornritzl
 */
public class GoogleDirectionsApi implements IDirectionsApi {
  ...
  @Override
  public void directions(String from,
                         String to,
                         TravelMode mode,
                         long departureTimeSeconds,
                         final OnDirectionsCallback callback) {
    ...
    rest.get("http://maps.googleapis.com/maps/api/directions/json",
             params,
