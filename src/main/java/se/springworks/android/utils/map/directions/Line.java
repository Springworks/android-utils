...
public class Line {
  ...
  public static class Vehicle {
    ...
    public enum Type {
      ...
      //	Trolleybus.
      SHARE_TAXI,
      //	Share taxi is a kind of bus with the ability to drop off and pick up passengers anywhere
      // on its route.
      FERRY,
      //	Ferry.
      CABLE_CAR,
      //	A vehicle that operates on a cable, usually on the ground. Aerial cable cars may be of
      // the type GONDOLA_LIFT.
      GONDOLA_LIFT,
      //	An aerial cable car.
      FUNICULAR,
