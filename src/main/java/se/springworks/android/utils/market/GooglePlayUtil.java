...
public class GooglePlayUtil {
  ...
  public static void showAppInGooglePlay(Activity a, String packageId) {
    try {
      a.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" +
                                                               packageId)));
    }
  ...
  public static void showPublisherInGooglePlay(Activity a, String publisherName) {
    try {
      a.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://search?q=pub:" +
                                                               publisherName)));
    }
    catch (android.content.ActivityNotFoundException anfe) {
      a.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(
          "http://play.google.com/store/search?q=pub:" + publisherName)));
    }
  }
  ...
  public static void searchInGooglePlay(Activity a, String searchQuery) {
    try {
      a.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://search?q=" +
                                                               searchQuery)));
    }
    catch (android.content.ActivityNotFoundException anfe) {
      a.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(
          "http://play.google.com/store/search?q=<query>" + searchQuery)));
    }
  }
}
